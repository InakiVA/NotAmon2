...
int main() {
  ...
  Mon* Bulb = new Mon("Bulbasaur",vB);
  Mon* Char = new Mon("Charmander",vC);
  Mon* Squr = new Mon("Squirtle",vS);
  Mon* Pika = new Mon("Pikachu",vP);  
  Mon* Jigy = new Mon("Jigglypuff",vJ);
